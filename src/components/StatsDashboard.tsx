    ...
    <div id="stats-dashboard">
      ...
      {activeTab === 'overview' && (
        <div>
              ...
              {stats.masteredWords && stats.masteredWords.length > 0 ? (
                <div className="flex flex-wrap gap-1.5 max-h-32 overflow-y-auto pr-1">
                  {stats.masteredWords.map(id => {
                    ...
                    return (
                      <span key={id} className="text-[11px] px-2 py-0.5 border border-[#2a2a2a] text-[#999]">
                        {matched?.word || id}
                      </span>
                    );
                  })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-[#1a1a1a] pt-8 mt-8">
            <div>
      ...
      {activeTab === 'profiles' && (
        <div>
          ...
          <div className="mt-10">
            <div className="text-[9px] tracking-[0.2em] text-[#666] uppercase mb-4">Errores frecuentes</div>
            <div className="border-t border-[#1a1a1a]">
